                ...
                <div>
                    ...
                    <menu className={isOpen ? 'absolute md:static md:mt-0 left-0 top-[70px] w-full px-8 py-3 duration-700 md:duration-0 bg-[#FBD062] md:bg-transparent' : 'absolute md:static mt-[-580px] md:mt-0 left-0 top-[70px] w-full px-8 py-3 duration-700 md:duration-0 bg-[#FBD062] md:bg-transparent'}>
                        <ul className='block md:flex md:flex-row justify-center items-center'>
                            ...
                            <li className='my-2 py-1 bg-[#f9c43d] md:bg-transparent hover:bg-yellow-600 duration-500 font-semibold hover:border-b-2 border-[#d09809]'>
                                <Link className='text-slate-200 px-2 py-2 focus:bg-[#111430] focus:text-white duration-300 rounded-sm cursor-pointer' to='/about' smooth={true} offset={50} duration={2000} >About</Link>
                            </li>
                            <li className='my-2 py-1 bg-[#f9c43d] md:bg-transparent hover:bg-yellow-600 duration-500 font-semibold hover:border-b-2 border-[#d09809]'>
                                <Link className='text-slate-200 px-2 py-2 focus:bg-[#111430] focus:text-white duration-300 rounded-sm cursor-pointer' to='/projects' smooth={true} offset={50} duration={2000} >My Projects</Link>
                            </li>
                            <li className='my-2 py-1 bg-[#f9c43d] md:bg-transparent hover:bg-yellow-600 duration-500 font-semibold hover:border-b-2 border-[#d09809]'>
                                <Link className='text-slate-200 px-2 py-2 focus:bg-[#111430] focus:text-white duration-300 rounded-sm cursor-pointer' to='/contact' smooth={true} offset={50} duration={2000} >Contact Me</Link>
                            </li>
